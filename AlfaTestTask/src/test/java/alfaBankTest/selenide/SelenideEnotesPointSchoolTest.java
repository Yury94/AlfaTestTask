...
public class SelenideEnotesPointSchoolTest extends TestBase {
    ...
    public void aEmptyBasket() throws InterruptedException {
        ...
        ListOfProductsInModulePage.validateModuleWindow();//проверка открытия окна корзины
        ListOfProductsInModulePage.buttonRedirect();//нажатие на кнопку "Перейти в корзину" в модалке
    ...
    public void cAddOneAnyProductWithDiscountToBasket() {
        ...
        LoginPage.attemptLogin("test", "test");//Логинимся
        HomePage.clickButtonBasket();//нажатие на иконку корзины
        ListOfProductsInModulePage.deletePartProduct();//удаление части товара добавленного из предыдущего теста!
